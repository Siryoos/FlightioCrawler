...
class TestCrawlerComprehensive:
    ...
    async def test_crawler_search_flights_signature(self, crawler_class, sample_flight_data):
    ...
    async def test_crawler_timeout_handling(self, crawler_class, sample_flight_data):
        ...
        # Mock slow response
        with patch.object(crawler, '_make_request', new_callable=AsyncMock) as mock_request:
    ...
    async def test_crawler_connection_error_handling(self, crawler_class, sample_flight_data):
    ...
    async def test_crawler_data_validation(self, crawler_class, sample_flight_data, mock_response):
