    ...
    def _parse_flight_element(self, element) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            flight_data = {
                ...
                "flight_number": self._extract_text(element, parsing_config.get("flight_number")),
                "departure_time": self._extract_text(element, parsing_config.get("departure_time")),
                "arrival_time": self._extract_text(element, parsing_config.get("arrival_time")),
                "duration": self._extract_text(element, parsing_config.get("duration")),
                "price": self._extract_price(self._extract_text(element, parsing_config.get("price"))),
                "cabin_class": self._extract_text(element, parsing_config.get("cabin_class"))
            }
