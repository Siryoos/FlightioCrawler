"""
Refactored ATA Air adapter using EnhancedPersianAdapter.
"""
...
class AtaAirAdapter(EnhancedPersianAdapter):
    """ATA Air adapter with minimal code duplication."""
    ...
    async def crawl(self, search_params: Dict) -> List[Dict]:
        try:
            ...
            self.logger.error(f"Error crawling Ata Air: {str(e)}")
