"""
Refactored Taban Air adapter using EnhancedPersianAdapter.
"""
...
class TabanAirAdapter(EnhancedPersianAdapter):
    """Taban Air adapter with minimal code duplication."""
    ...
    async def crawl(self, search_params: Dict) -> List[Dict]:
        try:
            ...
            self.logger.error(f"Error crawling Taban Air: {str(e)}")
