"""
Refactored Sepehran Air adapter using EnhancedPersianAdapter.
"""
...
class SepehranAirAdapter(EnhancedPersianAdapter):
    """Sepehran Air adapter with minimal code duplication."""
    ...
    def _get_base_url(self) -> str:
        return "https://www.sepehran.aero"
