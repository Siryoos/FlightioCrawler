"""
Refactored Qeshm Air adapter using EnhancedPersianAdapter.
"""
...
class QeshmAirAdapter(EnhancedPersianAdapter):
    """Qeshm Air adapter with minimal code duplication."""
    ...
    async def crawl(self, search_params: Dict) -> List[Dict]:
        try:
            ...
            self.logger.error(f"Error crawling Qeshm Air: {str(e)}")
    ...
    def _get_base_url(self) -> str:
        return "https://www.qeshmairlines.com"
