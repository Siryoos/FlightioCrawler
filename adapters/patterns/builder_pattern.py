...
class RateLimitingConfigBuilder(ConfigurationBuilder):
    ...
    def with_backoff_settings(self, factor: float, max_time: int) -> 'RateLimitingConfigBuilder':
    ...
    def with_adaptive_rate_limiting(self, enabled: bool = True) -> 'RateLimitingConfigBuilder':
...
class ErrorHandlingConfigBuilder(ConfigurationBuilder):
    ...
    def with_exponential_backoff(self, enabled: bool = True, factor: float = 2.0) -> 'ErrorHandlingConfigBuilder':
    ...
    def with_circuit_breaker(self, failure_threshold: int = 5, recovery_timeout: int = 300) -> 'ErrorHandlingConfigBuilder':
    ...
    def with_timeout(self, operation: str, timeout: int) -> 'ErrorHandlingConfigBuilder':
...
class MonitoringConfigBuilder(ConfigurationBuilder):
    ...
    def enable_database_logging(self, enabled: bool = True) -> 'MonitoringConfigBuilder':
        """Enable/disable database logging."""
        self._config.database_logging = enabled
        return self
    
    def with_alert_threshold(self, metric: str, threshold: float) -> 'MonitoringConfigBuilder':
        """Set alert threshold for a metric."""
        self._config.alert_thresholds[metric] = threshold
        return self
    
    def enable_performance_monitoring(self, enabled: bool = True) -> 'MonitoringConfigBuilder':
...
class ExtractionConfigBuilder(ConfigurationBuilder):
    ...
    def with_form_field(self, field_name: str, selector: str) -> 'ExtractionConfigBuilder':
        """Add form field selector."""
        self._config.search_form[field_name] = selector
        return self
    
    def with_result_selector(self, field_name: str, selector: str) -> 'ExtractionConfigBuilder':
        """Add result parsing selector."""
        self._config.results_parsing[field_name] = selector
        return self
    
    def with_wait_strategy(self, element: str, strategy: Dict[str, Any]) -> 'ExtractionConfigBuilder':
        """Add wait strategy for element."""
        self._config.wait_strategies[element] = strategy
        return self
    
    def with_language_setting(self, setting: str, value: str) -> 'ExtractionConfigBuilder':
        """Add language setting."""
        self._config.language_settings[setting] = value
        return self
    
    def with_text_processing(self, processor: str, config: Dict[str, Any]) -> 'ExtractionConfigBuilder':
    ...
    def for_persian_site(self) -> 'ExtractionConfigBuilder':
        ...
        return (self
                .with_language_setting("primary", "persian")
    ...
    def for_international_site(self) -> 'ExtractionConfigBuilder':
        ...
        return (self
                .with_language_setting("primary", "english")
...
class AdapterConfigBuilder(ConfigurationBuilder):
    ...
    def with_basic_info(self, base_url: str, currency: str, adapter_type: str, airline_name: str) -> 'AdapterConfigBuilder':
    ...
    def configure_error_handling(self, configurator: callable) -> 'AdapterConfigBuilder':
    ...
    def for_persian_airline(self, base_url: str, airline_name: str) -> 'AdapterConfigBuilder':
        """Configure for Persian airline."""
        return (self
                .with_basic_info(base_url, "IRR", "persian", airline_name)
    ...
    def for_international_airline(self, base_url: str, airline_name: str, currency: str = "USD") -> 'AdapterConfigBuilder':
        """Configure for international airline."""
        return (self
                .with_basic_info(base_url, currency, "international", airline_name)
    ...
    def for_aggregator(self, base_url: str, platform_name: str, currency: str = "IRR") -> 'AdapterConfigBuilder':
        """Configure for aggregator platform."""
        return (self
                .with_basic_info(base_url, currency, "aggregator", platform_name)
    ...
    def build(self) -> Dict[str, Any]:
        ...
        self._config.rate_limiting = RateLimitingConfig(**self._rate_limiting_builder.build())
        self._config.error_handling = ErrorHandlingConfig(**self._error_handling_builder.build())
        self._config.monitoring = MonitoringConfig(**self._monitoring_builder.build())
        self._config.extraction_config = ExtractionConfig(**self._extraction_builder.build())
...
class ConfigurationDirector:
    ...
    def build_mahan_air_config(self) -> Dict[str, Any]:
        ...
        return (self.builder
                ...
                .configure_extraction(lambda b: b
                    .with_form_field("origin_field", "#origin-input")
    ...
    def build_lufthansa_config(self) -> Dict[str, Any]:
        ...
        return (self.builder
                ...
                .configure_extraction(lambda b: b
                    .with_form_field("origin_field", "[data-testid='origin-input']")
                    .with_form_field("destination_field", "[data-testid='destination-input']")
