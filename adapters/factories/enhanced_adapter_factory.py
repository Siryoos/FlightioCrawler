...
class AbstractAdapterFactory(ABC):
    ...
    def build_config(self, metadata: AdapterMetadata, custom_config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        builder = (self.config_builder
                  ...
                  .with_base_config(metadata.config_template or {}))
...
class EnhancedAdapterFactory:
    ...
    def _detect_adapter_type(self, name: str) -> AdapterType:
        ...
        logger.warning(f"Could not detect type for adapter '{name}', defaulting to Persian")
    ...
    def get_adapter_info(self, name: str) -> Optional[AdapterMetadata]:
        ...
        for factory in self._factories.values():
            if name in factory.get_supported_adapters():
                if hasattr(factory, f'_{factory.__class__.__name__.lower().replace("adapterfactory", "")}_adapters'):
                    adapters_dict = getattr(factory, f'_{factory.__class__.__name__.lower().replace("adapterfactory", "")}_adapters')
