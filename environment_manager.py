...
class EnvironmentManager:
    ...
    def __init__(self):
        ...
        self.mock_data_dir = Path("requests/pages")
        
        logger.info(f"Environment Manager initialized: USE_MOCK={self.use_mock}, ENV={self.environment}")
    ...
    def get_mock_file_path(self, site_name: str, search_params: Dict[str, Any]) -> Optional[Path]:
        ...
        logger.warning(f"No mock file found for {site_name} with {origin}->{destination}")
        return None
    ...
    def log_execution_mode(self, site_name: str, action: str):
